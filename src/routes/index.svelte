<!-- website: Novao Technology's website, written with SvelteKit.
  ...
  <body>
    ...
    <Cover inner="<span>we are novao.</span>" />
    <div id="content">
      <div class="section">
        <h1>
          <span class="highlight"><i class="fa-solid fa-door-open" /></span>
        </h1>
        <h1>Our Code is <span class="mobileHighlight">Open</span></h1>
        <p>
          ...
          the infrastructure running our lives and the world.
        </p>
      </div>
      <div class="section">
      ...
      <div class="section">
        ...
        <h1>We Believe in <span class="mobileHighlight">Freedom</span></h1>
        <p>
          ...
          create this ideal world where all have these rights.
        </p>
      </div>
      <div class="section">
